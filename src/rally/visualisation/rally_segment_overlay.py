...
class RallySegmentDebugOverlay:
    ...
    Purpose:
        Visualize rally segmentation on video frames:
    ...
    Why this matters:
        Incorrect segmentation (e.g., start == end, missing trajectory)
        is one of the primary causes of the “1‑second highlight” bug.
    ...
    def draw(
        ...
        """
        Draw rally start/end markers and labels on a frame.
