...
class FrameOverlayGPU:
    ...
    def apply_to_video(self, clip_path: str, output_path: str):
        ...
        # Ensure Path objects are handled safely
        ...
        # Convert to strings for OpenCV + FFmpeg
        ...
        # FINAL RE-ENCODE
        self._ffmpeg_reencode(temp_output, final_output)

        # Cleanup
        if os.path.exists(temp_output):
            os.remove(temp_output)

        print(f"[FrameOverlay] Final MP4 saved → {final_output}")
